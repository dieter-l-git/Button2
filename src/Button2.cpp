...
Button2::Button2(uint8_t attachTo, uint8_t buttonMode /* = INPUT_PULLUP */, boolean activeLow /* = true */, Hardware *hardware /* = ArduinoHardware() */) {
...
void Button2::begin(uint8_t attachTo, uint8_t buttonMode /* = INPUT_PULLUP */, boolean activeLow /* = true */, Hardware *hardware /* = ArduinoHardware() */) {
  hw = hardware;
  pin = attachTo;
  longclick_counter = 0;
